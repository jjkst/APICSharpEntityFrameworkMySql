...
MYSQL_DATABASE="RukuITServicesTest"
...
mysql -h $MYSQL_HOST -u $MYSQL_USER -p$MYSQL_PASSWORD < CreateTestDatabase.sql

# Loop through all other .sql files except CreateDatabase.sql and CreateTestDatabase.sql and execute them
